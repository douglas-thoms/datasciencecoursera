rankall2 <- function(outcome, num = "best") {
        ...
        file_condensed[,selected_outcome] <- as.numeric(as.character(file_condensed[,selected_outcome]))
        ...
        bad <-is.na(ranked_hospitals[,selected_outcome])
        #View(bad,"bad")
        ranked_hospitals <-ranked_hospitals[!bad,]
...
#Probably need to do NA first to sort properly
